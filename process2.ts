...
// const content = fs.readFileSync("report3.txt", 'utf8');

// for (let l in content.split("\n")){
//   console.log("DEBUG",l);
// }
...
file.on('line', (line:string) => {
  ...
  //     //res.push(g[1])
  //   }
  //   //console.log(values2,res);
  //   console.log(name + "\t"+ res.join("\t"))
    
  //   //const sum = JSON.parse(value);
  //   //console.log([name,sum.count, sum.value].join("\t"));
  // }
